"""
Python requests 是一个常用的 HTTP 请求库，
可以方便地向网站发送 HTTP 请求，并获取响应结果
"""
...
"""
每次调用 requests 请求之后，会返回一个response对象，
该对象包含了具体的响应信息，如状态码、响应头、响应内容等

更多响应信息见：https://www.runoob.com/python3/python-requests.html
"""
# 获取响应状态码
...
# # 发送请求，参数可选不同方法
# response = requests.request('get', 'https://www.runoob.com/')  
...
# # 发送请求
# reponse = requests.post('https://www.runoob.com/try/ajax/demo_post.php')
...
# 发送请求
response = requests.post('https://www.runoob.com/try/ajax/demo_post2.php', data = myobj)
